...
public class RankMovieHorizontalAdapter extends RecyclerView.Adapter<RankMovieHorizontalAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView textMovieTitleEng;
        ...
        public ViewHolder(View v) {
            ...
            textMovieTitleEng = (TextView) mView.findViewById(R.id.movie_thisweek_eng_text);
    ...
    public void onBindViewHolder(ViewHolder holder,final int position) {
        ...
        holder.textMovieTitleEng.setText(mMovies.get(position).getTitle_eng());
