    ...
    public static ArrayList<Theater> getTheaters(int the_area_id){
        ...
        try {
            ...
            for (int i = 0; i < photoArray.length(); i++){
                ...
                if (area_id == the_area_id || the_area_id == 0){
                    Theater newTheater = new Theater(name, address, phone, area_id, theater_id);
